...
class ShardedVariable(ShardedVariableMixin, composite_tensor.CompositeTensor):
  ...
  def _deserialize_from_proto(cls, **kwargs):
    ...
    kwargs['shape'] = tensor_shape.TensorShape(object_proto.variable.shape)
    kwargs['dtype'] = dtypes.as_dtype(object_proto.variable.dtype)
