...
LogicalResult ScatterOp::verify() {
  ...
  auto scatter_indices_type =
      scatter_indices().getType().dyn_cast<ShapedType>();
  auto updates_type = updates().getType().dyn_cast<ShapedType>();
  ...
  // P5.
  if (operand_type_ranked && updates_type_ranked) {
  ...
  // P6.
  if (operand_type_ranked && scatter_indices_type_ranked) {
